...
class SimplisticTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        filename = os.path.join(os.path.dirname(__file__), 'maikon.xml') 
	...
	r = requests.post("http://177.72.161.165:8084/fashionmanager-api/api/integration/product?gumgaToken=INTEGRACAO_DATACOPER",data=body,headers=headers)
